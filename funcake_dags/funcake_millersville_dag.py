"""DAG to Harvest Millersville OAI & Index ("Publish") to SolrCloud."""
...
OAI_CONFIG = Variable.get("MILLERSVILLE_OAI_CONFIG", deserialize_json=True)
# {
...
XSL_CONFIG = Variable.get("MILLERSVILLE_XSL_CONFIG", deserialize_json=True)
#XSL_CONFIG = Variable.get("MILLERSVILLE_XSL_CONFIG", default_var={}, deserialize_json=True)
#{
...
XSL_FILENAME = XSL_CONFIG.get("xsl_filename", "transforms/millersvilleingest.xsl")
...
TARGET_ALIAS_ENV = Variable.get("MILLERSVILLE_TARGET_ALIAS_ENV", default_var="dev")
