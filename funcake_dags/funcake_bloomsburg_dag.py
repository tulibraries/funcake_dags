"""DAG to Harvest Bloomsburg OAI & Index ("Publish") to SolrCloud."""
...
OAI_CONFIG = Variable.get("BLOOMSBURG_OAI_CONFIG", deserialize_json=True)
# {
...
XSL_CONFIG = Variable.get("BLOOMSBURG_XSL_CONFIG", deserialize_json=True)
#XSL_CONFIG = Variable.get("BLOOMSBURG_XSL_CONFIG", default_var={}, deserialize_json=True)
#{
...
XSL_FILENAME = XSL_CONFIG.get("xsl_filename", "transforms/bloomsburgingest.xsl")
...
TARGET_ALIAS_ENV = Variable.get("BLOOMSBURG_TARGET_ALIAS_ENV", default_var="dev")
