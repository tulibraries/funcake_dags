"""DAG to Harvest Slippery Rock OAI & Index ("Publish") to SolrCloud."""
...
OAI_CONFIG = Variable.get("SLIPPERYROCK_OAI_CONFIG", deserialize_json=True)
# {
...
XSL_CONFIG = Variable.get("SLIPPERYROCK_XSL_CONFIG", deserialize_json=True)
#XSL_CONFIG = Variable.get("SLIPPERYROCK_XSL_CONFIG", default_var={}, deserialize_json=True)
#{
...
XSL_FILENAME = XSL_CONFIG.get("xsl_filename", "transforms/slipperyrockingest.xsl")
...
TARGET_ALIAS_ENV = Variable.get("SLIPPERYROCK_TARGET_ALIAS_ENV", default_var="dev")
