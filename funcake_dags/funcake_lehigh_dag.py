"""DAG to Harvest Lehigh OAI & Index ("Publish") to SolrCloud."""
...
OAI_CONFIG = Variable.get("LEHIGH_OAI_CONFIG", deserialize_json=True)
# {
...
XSL_CONFIG = Variable.get("LEHIGH_XSL_CONFIG", default_var={}, deserialize_json=True)
#{
...
TARGET_ALIAS_ENV = Variable.get("LEHIGH_TARGET_ALIAS_ENV", default_var="dev")
