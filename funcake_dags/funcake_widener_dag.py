"""DAG to Harvest Widener OAI & Index ("Publish") to SolrCloud."""
...
OAI_CONFIG = Variable.get("WIDENER_OAI_CONFIG", deserialize_json=True)
# {
...
XSL_CONFIG = Variable.get("WIDENER_XSL_CONFIG", default_var={}, deserialize_json=True)
#{
...
TARGET_ALIAS_ENV = Variable.get("WIDENER_TARGET_ALIAS_ENV", default_var="dev")
