"""DAG to Harvest Swarthmore/Haverford OAI & Index ("Publish") to SolrCloud."""
...
OAI_CONFIG = Variable.get("SWATHAVERFORD_OAI_CONFIG", deserialize_json=True)
# {
...
XSL_CONFIG = Variable.get("SWATHAVERFORD_XSL_CONFIG", default_var={}, deserialize_json=True)
#{
...
TARGET_ALIAS_ENV = Variable.get("SWATHAVERFORD_TARGET_ALIAS_ENV", default_var="dev")
