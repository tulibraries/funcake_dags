"""DAG to Harvest SHI OAI & Index ("Publish") to SolrCloud."""
...
OAI_CONFIG = Variable.get("SHI_OAI_CONFIG", deserialize_json=True)
# {
...
XSL_CONFIG = Variable.get("SHI_XSL_CONFIG", default_var={}, deserialize_json=True)
#{
...
XSL_FILENAME = XSL_CONFIG.get("xsl_filename", "transforms/SHIingest.xsl")
...
TARGET_ALIAS_ENV = Variable.get("SHI_TARGET_ALIAS_ENV", default_var="dev")
