""" DAG to harvest data from DPLAH OAI endpoint"""
...
def slackpostonsuccess(dag, **context):
    """Task Method to Post Successful DPLAH DAG Completion on Slack."""
...
XSL_CONFIG = Variable.get("DPLAH_XSL_CONFIG", default_var={}, deserialize_json=True)
#{
...
SOLR_CONFIGSET = Variable.get("DPLAH_SOLR_CONFIGSET", default_var="funcake-oai-0")
