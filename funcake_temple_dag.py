""" DAG to harvest data from Temple OAI endpoint"""
...
def slackpostonsuccess(dag, **context):
    """Task Method to Post Successful Temple DAG Completion on Slack."""
...
SOLR_CONFIGSET = Variable.get("TEMPLE_SOLR_CONFIGSET", default_var="funcake-oai-0")
